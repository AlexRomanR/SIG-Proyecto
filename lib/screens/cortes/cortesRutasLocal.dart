      ...
      body: FutureBuilder<List<RutasSinCortar>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('Error al cargar rutas guardadas', style: TextStyle(color: Colors.red)));
          } else if (!snapshot.hasData || snapshot.data!.isEmpty) {
            return Center(child: Text('No hay rutas guardadas', style: TextStyle(color: Colors.white)));
          }
